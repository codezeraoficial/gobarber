...
export default function Dashboard() {
  ...
  return (
    <Container>
      <header>
        <button type="button" onClick={handlePrevDay}><MdChevronLeft color="#FFF" size={36} /></button>
        <strong>{dateFormatted}</strong>
        <button type="button" onClick={handleNextDay}><MdChevronRight color="#FFF" size={36} /></button>
      </header>
